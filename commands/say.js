...
module.exports = {
    ...
    run: async(client, message, args) => {
        ...
        const embed = new Discord.MessageEmbed()
            ...
            .setDescription(`
            <a:hosgeldin:881632441431904287> **Sunucumuz da** ${emotoplamüye} **kişi bulunmakta.**
            <a:hosgeldin:881632441431904287> **Sunucumuz da** ${emoonline} **aktif kişi bulunmakta.**
            <a:hosgeldin:881632441431904287> **Sunucumuz da** ${emotag} **taglı üye bulunmakta.**
            <a:hosgeldin:881632441431904287> **Sunucumuzu boostlayan** ${emoboost} **kişi bulunmakta.**
            <a:hosgeldin:881632441431904287> **Ses kanallarında** ${emoses} **kişi bulunmakta.**
            `)
